...
func (p *ServiceGoTSRPCProxy) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	if callStats != nil {
		...
		callStats.Package = "github.com/janhalfar/vocablion/services/words"
	...
	case "Search":
		...
		searchState, searchErr := p.service.Search(w, r, arg_query)
		if callStats != nil {
			callStats.Execution = time.Now().Sub(executionStart)
		}
		gotsrpc.Reply([]interface{}{searchState, searchErr}, callStats, r, w)
		return
	default:
